...
Component({
  ...
  methods: {
    ...
    onClickBox (e) {
      this.triggerEvent("onClickBox", e.detail)
    },

    movableChange (e) {
      this.triggerEvent("movableChange", e.detail)
    },

    onScale (e) {
      this.triggerEvent("onScale", e.detail)
    },
